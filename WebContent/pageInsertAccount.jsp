...
<body style="background-color: #999966;">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs+4 text-left">
                                    <div class="huge"><a href="pageUser.jsp" style="color: white;">USER</a> > <a href="#" style="color: white;">INSERT</a></div>
                                    <div></div>
                                </div>
                            </div>
                        </div>
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Thêm tài khoản người dùng</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="UserController">
                                        <div class="form-group">
                                            <label>Tài khoản</label>
                                            <input name="usr_id" class="form-control" placeholder="Enter text">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Mật khẩu</label>
                                            <input name="usr_passwd" class="form-control" placeholder="Enter text">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Mail</label>
                                            <input name="usr_mail" class="form-control" placeholder="E-mail"  type="email" autofocus>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Type</label>
                                            <select name="usr_onl_facebook" class="form-control">
                                                <option>admin</option>
                                                <option>user</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>name</label>
                                            <input name="usr_name" class="form-control" placeholder="Enter text">
                                        </div>
                                        
                                        <button name="btsubmit" value="serverinsert" type="submit" class="btn btn-default">Submit Button</button>
