<%@page import="yama.database.Top100"%>
<%@page import="yama.database.OnlineSong"%>
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs+4 text-left">
									<div class="huge">Bảng xếp hạng bài hát</div>
									<div></div>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-6 col-md-6">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">tabTop100</div>
                            <!-- /.panel-heading -->
                            ...
                            <table width="100%"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="2" align="center"><a
                                                href="pageInsertAccount.jsp">INSERT</a></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
                                        ...
                                        if (index1 != null) {
                                            offset1 = Integer.parseInt(index1);
                                        }
                                        String url = "https://nhac.vn/bang-xep-hang-bai-hat-viet-nam-bxdE";
                                        ArrayList<Top100> arrayList1 = Top100.TOP_get_Top(url);
                                        for (Top100 song1 : arrayList1) {
                                    %>
                                        <tr class="odd gradeX">
                                            <td class="center"><%=song1.TOP_get_index()%></td>
                                            <td class="center"><%=song1.TOP_get_category()%></td>
                                            <td class="center"><%=song1.TOP_get_id()%></td>
                                            <td class="center"><%=song1.TOP_get_name()%></td>
                                            <td class="center"><%=song1.TOP_get_link_page_infor()%></td>
                                            <td class="center"><%=song1.TOP_get_link_mp3()%></td>
                                            <td class="center"><%=song1.TOP_get_link_img()%></td>
                                            <td class="center"><%=song1.TOP_get_link_lyric()%></td>
                                ...
                                <!-- /.table-responsive -->
                                <%
                            String urlNext1 = null;
                            urlNext1 = "pageUser.jsp?index=" + (offset1 + 1);
                            String urlPri1 = null;
                            urlPri1 = "pageUser.jsp?index=" + (((offset1) > 0) ? (offset1 - 1) : 0);
                            %>
                                <a href="<%=urlPri1 %>"><button type="button"
                                        class="btn btn-primary">Prious</button></a> <a href="#"><button
                                        type="button" class="btn btn-primary"><%=offset1%></button></a> <a
                                    href="<%=urlNext1%>"><button type="button"
				...
				<div class="col-lg-6 col-md-6">
							...
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-2">
                                        ...
                                        <input  class="btn btn-primary" name="btsubmit" value="sysn" type="submit">
                                        </form>
                                    </div>
								</div>
							</div>
					...
					<div class="col-lg-12 col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<table width="100%"
									...
									<tbody>
                                        ...
                                        ArrayList<Top100> arrayList = Top100.TOP_get_list_song(offset, 20);
                                        for (Top100 song : arrayList) {
                                    %>
										<tr class="odd gradeX">
											<td class="center"><%=song.TOP_get_index()%></td>
											<td class="center"><%=song.TOP_get_category()%></td>
											<td class="center"><%=song.TOP_get_id()%></td>
											<td class="center"><%=song.TOP_get_name()%></td>
											<td class="center"><%=song.TOP_get_link_page_infor()%></td>
											<td class="center"><%=song.TOP_get_link_mp3()%></td>
											<td class="center"><%=song.TOP_get_link_img()%></td>
											<td class="center"><%=song.TOP_get_link_lyric()%></td>
											<td class="center">EDIT</td>
											<td class="center">DELETE</td>
                            ...
                            %>
								<a href="<%=urlPri %>"><button type="button"
										class="btn btn-primary">Prious</button></a> <a href="#"><button
										type="button" class="btn btn-primary"><%=offset%></button></a> <a
									href="<%=urlNext%>"><button type="button"
										class="btn btn-primary">Next</button></a>
